// 10.1: Përdorimi i tagjeve elementare të JavaScript-ave
function slideNext()// 19.8: Krijimi dhe përdorimi i funksioneve në JS me dhe pa parametra
{
    ...
    document.img1.src = images[4]; document.getElementById("p_1").innerHTML = desc[2]; document.getElementById("h2_1").innerHTML = headings[2]; // 10.3: Përdorimi i JavaScript për manipulim me tekst si dheshfrytëzimi i getElementbyId
